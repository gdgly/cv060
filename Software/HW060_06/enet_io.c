...
#include "driverlib/gpio.h"
#include "utils/uartstdio.h"
#include "custom_port/cv_port.h"
#include "custom_port/modbus_port.h"
...
//#define DHCP_EXPIRE_TIMER_SECS  1
#endif

//-------------------------------- Peter --------------------------------
unsigned char pucMACArray[8];
extern unsigned char Time_To_Store;
//-------------------------------- Peter --------------------------------
//*****************************************************************************
//
...
void stellaris_init(void)
{
    ...
    //
	//IntPendClear(0xffffffff);
//	SysCtlIntClear(0xffffffff);
//	Base 0xE000ED2C
//	*(unsigned long*)0xE000ED2C=0;
//    IntMasterEnable();
...
//    lwIPInit(pucMACArray, 0, 0, 0, IPADDR_USE_DHCP);
    ...
    LocatorAppTitleSet("CV060 System");
...
void stellaris_run(void)
{
	...
	while(UARTCharsAvail(UART1_BASE)) upc_RXHandler();		
}