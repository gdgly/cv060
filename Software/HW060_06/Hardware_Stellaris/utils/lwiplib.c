...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/api/api_lib.c"
#include "third_party/lwip-in-use/src/api/api_msg.c"
#include "third_party/lwip-in-use/src/api/err.c"
#include "third_party/lwip-in-use/src/api/netbuf.c"
#include "third_party/lwip-in-use/src/api/netdb.c"
#include "third_party/lwip-in-use/src/api/netifapi.c"
#include "third_party/lwip-in-use/src/api/sockets.c"
#include "third_party/lwip-in-use/src/api/tcpip.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/core/dhcp.c"
#include "third_party/lwip-in-use/src/core/dns.c"
#include "third_party/lwip-in-use/src/core/init.c"
#include "third_party/lwip-in-use/src/core/mem.c"
#include "third_party/lwip-in-use/src/core/memp.c"
#include "third_party/lwip-in-use/src/core/netif.c"
#include "third_party/lwip-in-use/src/core/pbuf.c"
#include "third_party/lwip-in-use/src/core/raw.c"
#include "third_party/lwip-in-use/src/core/stats.c"
#include "third_party/lwip-in-use/src/core/sys.c"
#include "third_party/lwip-in-use/src/core/tcp.c"
#include "third_party/lwip-in-use/src/core/tcp_in.c"
#include "third_party/lwip-in-use/src/core/tcp_out.c"
#include "third_party/lwip-in-use/src/core/udp.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/core/ipv4/autoip.c"
#include "third_party/lwip-in-use/src/core/ipv4/icmp.c"
#include "third_party/lwip-in-use/src/core/ipv4/igmp.c"
#include "third_party/lwip-in-use/src/core/ipv4/inet.c"
#include "third_party/lwip-in-use/src/core/ipv4/inet_chksum.c"
#include "third_party/lwip-in-use/src/core/ipv4/ip.c"
#include "third_party/lwip-in-use/src/core/ipv4/ip_addr.c"
#include "third_party/lwip-in-use/src/core/ipv4/ip_frag.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/core/snmp/asn1_dec.c"
#include "third_party/lwip-in-use/src/core/snmp/asn1_enc.c"
#include "third_party/lwip-in-use/src/core/snmp/mib2.c"
#include "third_party/lwip-in-use/src/core/snmp/mib_structs.c"
#include "third_party/lwip-in-use/src/core/snmp/msg_in.c"
#include "third_party/lwip-in-use/src/core/snmp/msg_out.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/netif/etharp.c"
#include "third_party/lwip-in-use/src/netif/loopif.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/src/netif/ppp/auth.c"
#include "third_party/lwip-in-use/src/netif/ppp/chap.c"
#include "third_party/lwip-in-use/src/netif/ppp/chpms.c"
#include "third_party/lwip-in-use/src/netif/ppp/fsm.c"
#include "third_party/lwip-in-use/src/netif/ppp/ipcp.c"
#include "third_party/lwip-in-use/src/netif/ppp/lcp.c"
#include "third_party/lwip-in-use/src/netif/ppp/magic.c"
#include "third_party/lwip-in-use/src/netif/ppp/md5.c"
#include "third_party/lwip-in-use/src/netif/ppp/pap.c"
#include "third_party/lwip-in-use/src/netif/ppp/ppp.c"
#include "third_party/lwip-in-use/src/netif/ppp/ppp_oe.c"
#include "third_party/lwip-in-use/src/netif/ppp/randm.c"
#include "third_party/lwip-in-use/src/netif/ppp/vj.c"
...
//
//*****************************************************************************
#include "third_party/lwip-in-use/ports/stellaris/perf.c"
#include "third_party/lwip-in-use/ports/stellaris/sys_arch.c"
#include "third_party/lwip-in-use/ports/stellaris/netif/stellarisif.c"
...
//*****************************************************************************
unsigned long ulStatus;
unsigned long ul_Eth_Irq = 0;

void Peter_lwIPEthernetIntHandler(void)
{
    //
    // Read and Clear the interrupt.
    //
...
//*****************************************************************************
void Peter_lwIPEthernetIntHandler_Poll(void)
{
#if !NO_SYS
    portBASE_TYPE xWake;
#endif
	if (ul_Eth_Irq == 0)return;
	ul_Eth_Irq = 0;
    //
    // The handling of the interrupt is different based on the use of a RTOS.
    //
