...
#define com_get_enabled_options		53

#define com_get_register_adv		54
#define com_set_register_adv		55

#define com_set_do					80
//----- Reg advanced define ----------
	typedef struct
	{
		u16 addr;
	...
	#define BLOCK_PID		1
	#define BLOCK_FAN		2
	#define BLOCK_KOTEL		3
	#define BLOCK_VALVE		4
	#define BLOCK_SEASON	5
	#define BLOCK_SCHEDULE	6
	#define BLOCK_PARAMETERS	7
//------------------------------------
#define com_get_work_rec			56
#define com_set_work_rec			57
#define com_get_misc_rec			58
#define com_set_misc_rec			59
