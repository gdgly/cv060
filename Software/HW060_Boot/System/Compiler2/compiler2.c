...
#if MAX_PARAMS_BLOCK
		case TYPE_REG+80:			tmp32=misc.pr[op.index];break;	
#endif			
	}
	return tmp32;
}
...
//		case TYPE_REG+56:			v3t.close=value;break;	
		...
		case TYPE_REG+60:			if(op.index<NUM_PID)pid[op.index].power=value;break;			
...
#if MAX_PARAMS_BLOCK
		case TYPE_REG+80:			misc.pr[op.index]=value;break;	
#endif				
	}
}
//-----------------------------------------------------------------------------------
