...
void fram_mem_write(u16 addr,u8* data, u16 len)
{
	...
	Addr[0]=addr>>8;
	Addr[1]=addr;	
	I2C_NiMasterWrite(0xA2>>1,Addr,2,data,len);
#endif	
}
//-----------------------------------------------------------------------------------
void fram_mem_read(u16 addr,u8* data, u16 len)
{
	...
	Addr[0]=addr>>8;
	Addr[1]=addr;	
	I2C_NiMasterRead(0xA2>>1,Addr,2,data,len);	
#endif		
}
//-----------------------------------------------------------------------------------
void fram_comp_write(u8 addr,u8* data, u16 len)
{
	...
	Addr[0]=addr;
	Addr[1]=0;	
	I2C_NiMasterWrite(0xd2>>1,Addr,1,data,len);
#endif		
}
//-----------------------------------------------------------------------------------
void fram_comp_read(u8 addr,u8* data, u16 len)
{
	...
	Addr[0]=addr;
	Addr[1]=0;	
	I2C_NiMasterRead(0xd2>>1,Addr,1,data,len);	
#endif		
}
//-----------------------------------------------------------------------------------
